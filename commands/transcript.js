...
module.exports = {
    ...
    async execute(message, args, client){
       ...
       // await message.delete();
        ...
        let data = await fs.readFile('./template/template.html', 'utf8').catch(err => console.log(err));
        if(data) {
            await fs.writeFile('template/index.html', data).catch(err => console.log(err));
            ...
            await fs.appendFile('template/index.html', guildElement.outerHTML).catch(err => console.log(err));
            ...
            msgs.forEach(async msg => {
                ...
                await fs.appendFile('template/index.html', parentContainer.outerHTML).catch(err => console.log(err));
                //let attachment = new discord.MessageAttachment()
                
                //.attachFiles(`attachment://../template/index.html`)
            });
        }
        ...
        message.channel.send({files: [{attachment: './template/index.html', name: 'transcript.html'}]})
